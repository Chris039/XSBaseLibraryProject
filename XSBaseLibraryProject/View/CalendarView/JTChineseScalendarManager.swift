//
//  JTChineseScalendarManager.swift
//  松鼠Demo
//
...
class JTChineseScalendarManager: NSObject {
    ...
    func getChineseCalendarWithDate(date:NSDate,calendarItem:JTSectionCalendarModel) {
